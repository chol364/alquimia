import "./wasm_exec.js";
export declare const ZEBRASH_VERSION: string;
export type ZplApi = {
    /**
     ...
     * ```
     */
    zplToBase64MultipleAsync: (zpl: string, widthMm?: number, heightMm?: number, dpmm?: number) => Promise<string[]>;
};
...
export declare function zplToBase64MultipleAsync(zpl: string, widthMm?: number, heightMm?: number, dpmm?: number): Promise<string[]>;
